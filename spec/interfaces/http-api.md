...
This is an execution profile governed by the [core specification](../core.md). "API" is a broader term than HTTP; this document describes HTTP interfaces. See the [interface overview](../interfaces.md) for other access paths.
